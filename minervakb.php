...
/*
* Plugin Name: MinervaKB FAQs Fork
* Description: Minerva KB - A fork of MinervaKB with only the FAQs feature included and improved.
...
define('MINERVA_KB_VERSION', '1.5.0');
